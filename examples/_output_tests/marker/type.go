...
import (
	"github.com/j2gg0s/godefault/examples/output_tests/empty"
	"github.com/j2gg0s/godefault/examples/output_tests/marker/external3"
)
...
type DefaultedWithReference struct {
	...
	// +default=ref(github.com/j2gg0s/godefault/examples/output_tests/marker/external.AConstant)
	SameNamePackageSymbolReference1 string `json:",omitempty"`

	// +default=ref(github.com/j2gg0s/godefault/examples/output_tests/marker/external/external.AnotherConstant)
	...
	// +default=ref(github.com/j2gg0s/godefault/examples/output_tests/marker.SomeValue)
